(function (e) {
    ...
    var c = {}, d = {
        ...
        b = '<style id="css-ddslick" type="text/css">.' +
            ...
            'dd-selected{ height: 50px; color:#ffffff; overflow:hidden; display:flex;align-items: center; padding:5px; font-weight:normal;}.' +
            'dd-pointer{ width:0; height:0; position:absolute; right:10px; top:50%; margin-top:-3px;}.' +
            'dd-pointer-down{ border:solid 5px transparent; border-top:solid 5px #FFFFFF; }.' +
            'dd-pointer-up{ border:solid 5px transparent !important; border-bottom:solid 5px #ffffff !important; margin-top:-8px;}.' +
            'dd-options{ border:solid 1px #ccc; border-top:none; list-style:none; box-shadow:0px 1px 5px #ddd; display:none; position:absolute;' +
            ' z-index:2000; margin:0; padding:0;background:transparent; overflow:auto;}.' +
            'dd-option{ height:50px; padding:10px; display:flex; align-items:center;border-bottom:solid 1px #ddd; overflow:hidden; text-decoration:none; color:#ffffff; cursor:pointer;-webkit-transition: all 0.25s ease-in-out; -moz-transition: all 0.25s ease-in-out;-o-transition: all 0.25s ease-in-out; }.' +
            'dd-options > li:last-child > .' +
            'dd-option{  border-bottom:none;}.' +
            'dd-option:hover{ background:#f3f3f3; color:#000000;}.' +
            'dd-selected-description-truncated { text-overflow: ellipsis; white-space:nowrap; }.' +
            'dd-option-selected { background: transparent; }.' +
            'dd-option-image, .' +
            'dd-selected-image { width: 35px; height: 35px; border-radius: 50%; vertical-align:middle; float:left; margin-right:10px; max-width:64px;}.' +
            'dd-image-right { float:right; margin-right:15px; margin-left:5px;}.' +
            'dd-container{ position:relative;}​ .' +
            'dd-selected-text { font-weight:normal}​</style>';
    c.init = function (l) {
        var l = e.extend({}, d, l);
